...
public class FileED {
	...
	public static void main(String[] args) {																																																																																																																																																																																																																																																																																																								
		...
		try {
			...
			Matrix2D CAF = Database.ExtractCommitArtifactMatrix(Grain.METHOD, projName, 
					"java/engine/org/apache/derby/impl/jdbc/EmbedConnection.java");
			Matrix2D DC = Database.ExtractDeveloperCommitMatrix(projName, 
					"java/engine/org/apache/derby/impl/jdbc/EmbedConnection.java");
			
			Matrix2D DAF = DC.CPUMultiplication(CAF); 
			DAF.ExportCSV("Teste.csv");
			
			Matrix2D DAFZ = StandardScore.Process(DAF, true);
			DAFZ.ExportCSV("TesteSS.csv");
